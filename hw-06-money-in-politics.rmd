...
knitr::opts_chunk$set(
  eval = TRUE,  # Changed to TRUE to execute code
  out.width = "80%",
  fig.asp = 0.618,
  fig.width = 10,
  dpi = 300
...
The dataset contains `r nrow(pac_all)` observations and `r ncol(pac_all)` variables.
...
The plot reveals that UK-connected PACs have generally contributed more to Republican candidates than Democratic candidates over most election cycles. There are notable fluctuations in both parties' contributions over time, with some years showing particularly high contributions to one party or the other.
